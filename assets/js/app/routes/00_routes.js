                                ...
                                resolve: {
                                    _route: [
                                        ...
                                        function resolve(RoutesService, $stateParams) {
                                            console.log("RouteController-RoutesService", $stateParams)
                                    ...
                                    _service: [
                                        'RoutesService', '$stateParams',
                                        function resolve(RoutesService, $stateParams) {
                                            return RoutesService.findServiceByRouteId($stateParams.route_id)
                                        }
                                    ],
                                    _gateway: [
                                        'InfoService',
